...
function register_ca () {
    ...
    do
        ...
        fabric-ca-client register --id.name ${my_array[1]} --id.secret  ${my_array[2]} --id.type peer -u https://0.0.0.0:${PORT}
    done < "$input"
...
function enroll_nodes () {
    ...
    do
        ...
        do  
            my_array[$y]=$word
            mkdir -p ${FILE}/organizations/${ORG,,}/peers/${my_array[1]}
            y=y+1
            USERNAME=${my_array[1]}
            PASSWORD=${my_array[2]}
        done
...
function register_ca_orderer () {
    ...
    do
        ...
        fabric-ca-client register --id.name ${my_array[1]} --id.secret  ${my_array[2]} --id.type orderer -u https://0.0.0.0:${PORT}
    done < "$input"
...
function enroll_nodes_orderer () {
    ...
    do
        ...
        do  
            my_array[$y]=$word
            mkdir -p ${FILE}/organizations/${NAME,,}/orderers/${my_array[1]}
            y=y+1
            USERNAME=${my_array[1]}
            PASSWORD=${my_array[2]}
        done
