...
func main() {
	...
	//fmt.Println("Value:")
	//fmt.Scan(&value1)
	//getAllAssets(contract, "Color", "blue")
	//fmt.Println("Value:")
	//fmt.Scan(&value2)
	//GetQR(contract, "New York")
	//updateGPS(contract)
...
func GetQR(contract *client.Contract, value string) {
	...
	evaluateResult, err := contract.EvaluateTransaction("GPSsearch", value)
	if err != nil {
		panic(fmt.Errorf("failed to evaluate transaction: %w", err))
	}
	//result := formatJSON(evaluateResult)
...
func createAsset(contract *client.Contract) {
	...
	fmt.Println(value)
	_, err := contract.SubmitTransaction("CreateAsset", "abc12", "blue", "5", "Tom", "1300", category, value, "38.055754217921795", "23.780976250743787", "New York")
	if err != nil {
		panic(fmt.Errorf("failed to submit transaction: %w", err))
	}
	fmt.Printf("*** Transaction committed successfully\n")
...
func updateGPS(contract *client.Contract) {
	...
	_, err := contract.SubmitTransaction("UpdateGPS", "abc12", "39.055754217921795", "25.780976250743787", "Crete")
	if err != nil {
		panic(fmt.Errorf("failed to submit transaction: %w", err))
	}
	fmt.Printf("*** Transaction committed successfully\n")
